...
<div class="card mb-3">
	...
	<div class="card-body">
		<sf:form class="form-horizontal" modelAttribute="halalAnalysisReport"
			action="${contextRoot}/supplier/product/${product.id}/halalanalysis" method="POST" enctype="multipart/form-data">
			<div class="modal-body">
				<table>
					...
					<tr>
						...
						<td>
							<a href="${contextRoot}/supplier/product/${product.id}/halalanalysis" class="btn btn-secondary">Cancel</a>&nbsp;&nbsp;
