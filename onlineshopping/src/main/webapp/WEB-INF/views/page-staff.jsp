...
<body id="page-top">
	...
	<%@include file="staff/shared/navbar.jsp"%>

	<div id="wrapper">

		<!-- Sidebar -->
		<%@include file="staff/shared/sidebar.jsp"%>
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<c:if test="${userClickDashboard == true }">
					<%@include file="staff/dashboard.jsp"%>
				</c:if>

				<c:if test="${userClickOnsiteAssessments == true }">
					<%@include file="staff/manageOnsite.jsp"%>
				</c:if>	
				
				<c:if test="${userClickProducts == true }">
					<%@include file="staff/manageProduct.jsp"%>
				</c:if>

				<c:if test="${userClickSupplier == true }">
					<%@include file="staff/manageSupplier.jsp"%>
				</c:if>

				<c:if test="${userClickIngredient == true }">
					<%@include file="staff/manageIngredient.jsp"%>
				</c:if>

				<c:if test="${userClickShipment == true }">
					<%@include file="staff/manageShipment.jsp"%>
				</c:if>

				<c:if test="${userClickCertificate == true }">
					<%@include file="staff/manageCertification.jsp"%>
				</c:if>

				<c:if test="${userClickCats == true }">
					<%@include file="staff/manageCategory.jsp"%>
				</c:if>
				<c:if test="${userClickCat == true }">
					<%@include file="staff/category.jsp"%>
				</c:if>

				<c:if test="${productForm == true }">
					<%@include file="staff/product.jsp"%>
				</c:if>

				<c:if test="${ingredientForm == true }">
					<%@include file="staff/ingredient.jsp"%>
				</c:if>
	
				<c:if test="${productIngredientsForm == true }">
					<%@include file="staff/product-ingredient.jsp"%>
				</c:if>	
	
				<c:if test="${productIngredientDetailForm == true }">
					<%@include file="staff/ingredient-detail.jsp"%>
				</c:if>		
	
				<c:if test="${supplierForm == true }">
					<%@include file="staff/supplier.jsp"%>
				</c:if>		
	
				<c:if test="${supplierProductsForm == true }">
					<%@include file="staff/supplier-product.jsp"%>
				</c:if>	
								
								
				<c:if test="${onsiteAssessmentForm == true }">
					<%@include file="staff/onsiteassessment.jsp"%>
				</c:if>	

				<c:if test="${userClickNutritionfact == true }">
					<%@include file="staff/manageNutritionFacts.jsp"%>
				</c:if>	
								
				<c:if test="${nutritionfactsForm == true }">
					<%@include file="staff/nutritionfact.jsp"%>
				</c:if>	
				
				<c:if test="${userClickHalalParameters == true }">
					<%@include file="staff/manageHalalParameter.jsp"%>
				</c:if>	
				<c:if test="${halalParamForm == true }">
					<%@include file="staff/halalparameter.jsp"%>
				</c:if>									
				              
				<c:if test="${productHalalParamForm == true }">
					<%@include file="staff/product-halalanalysis.jsp"%>
				</c:if>					
				
				<c:if test="${halalAnalysisReportForm == true }">
					<%@include file="staff/halalanalysisreport.jsp"%>
				</c:if>
	
				<c:if test="${productNutritionFactsParamForm == true }">
					<%@include file="staff/product-nutritionfactsresult.jsp"%>
				</c:if>					
				
				<c:if test="${nutritionFactsResultForm == true }">
					<%@include file="staff/nutritionfactsresult.jsp"%>
				</c:if>
				
				<c:if test="${certificateForm == true }">
					<%@include file="staff/certification.jsp"%>
				</c:if>
	
				<c:if test="${userClickOrders == true }">
					<%@include file="staff/manageOrder.jsp"%>
				</c:if>				
			</div>
			<!-- /.container-fluid -->
