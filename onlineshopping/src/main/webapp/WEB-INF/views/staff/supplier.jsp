...
<div class="card mb-3">
	...
	<div class="card-body">
		<sf:form class="form-horizontal" modelAttribute="supplier"
			action="${contextRoot}/staff/supplier" method="POST" enctype="multipart/form-data">
			<div class="modal-body">
				<table>
					<tr>
						<td><sf:label path="nameOfEstablishment" class="control-label">Company Name</sf:label></td>
						<td><sf:input path="nameOfEstablishment" class="form-control" placeholder="Company Name"  required="required" readonly="true"/></td>
					</tr>

	
						<tr>
						<td><sf:label path="addressOfEstablishment" class="control-label">Company Address</sf:label></td>
						<td><sf:input path="addressOfEstablishment" class="form-control" placeholder="Company Address" required="required" readonly="true"/></td>
					...
					<tr>
						...
						<td><sf:input path="email" class="form-control" type="email" placeholder="Email"  required="required" readonly="true"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><a href="${contextRoot}/staff/suppliers"
