...
<div class="card mb-3">
	...
	<div class="card-body">
		<sf:form class="form-horizontal" modelAttribute="halalparameter"
			action="${contextRoot}/laboratory/halalparameter" method="POST">
			<div class="modal-body">
				<table>
					...
					<tr>
						...
						<td><a href="${contextRoot}/laboratory/halalparameter"
