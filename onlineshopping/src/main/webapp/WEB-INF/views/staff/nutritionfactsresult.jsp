...
<div class="card mb-3">
	...
	<div class="card-body">
		<sf:form class="form-horizontal" modelAttribute="nutritionFactsResult"
			action="${contextRoot}/staff/product/${product.id}/nutritionfactsresult" method="POST" enctype="multipart/form-data">
			<div class="modal-body">
				<table>
					...
					<tr>
						...
						<td>
							<a href="${contextRoot}/staff/product/${product.id}/nutritionfactsresult" class="btn btn-secondary">Cancel</a>&nbsp;&nbsp;
