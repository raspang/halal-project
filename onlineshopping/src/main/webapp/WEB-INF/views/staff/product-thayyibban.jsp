...
<div class="card mb-3">
	...
	<div class="card-body">
		...
		<div class="modal-body">
			<table class="table table-bordered">
				...
				<c:forEach items="${ingredientDetails}" var="ingredient">
					<tr>
						...
						<td>
							<a href="${contextRoot}/staff/product/${product.id}/ingredients/${ingredient.id}/delete" data-confirm="Are you sure you want to delete?">Delete</a>
			...
			<a href="${contextRoot}/staff/products" class="btn btn-lg btn-primary">Back</a>
...
<div class="modal fade" id="modalIngredientDetailId" tabindex="-1"
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<sf:form class="form-horizontal" modelAttribute="ingredientDetail"  action="${contextRoot}/staff/product/${product.id}/ingredients/ingredient" method="POST"
