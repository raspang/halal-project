			...
			<div class="row carousel-holder">
					...
					<div id="carousel-example-generic" class="carousel slide"
						...
						<div class="carousel-inner">
							...
							<div class="item active">
								<img class="slide-image" src="${images}/Bannershalallab3.png"
									alt="">
							</div>
		
							<div class="item">
								<img class="slide-image" src="${images}/Bannershalallab4.png"
									alt="">
							</div>
		
							<div class="item">
								<img class="slide-image" src="${images}/Bannershalallab2.png"
									alt="">
							</div>
						</div>
                ...
                <div class="row is-table-row">
                    ...
                    <div class="col-sm-4" ng-repeat="product in pCtrl.mvProducts">                    	
                        <div class="thumbnail">
                            <img ng-src="${images}/{{product.code}}.png" alt="{{product.name}}" class="landingImg">
                            <h5>{{product.name}}</h5>
                            <hr/>
                            <div class="caption">
