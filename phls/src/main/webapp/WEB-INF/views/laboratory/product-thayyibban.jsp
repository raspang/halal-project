	...
	<div class="card-body">
		...
		<div class="modal-body">
				...
				<c:forEach items="${ingredientDetails}" var="ingredient">
					<tr>
						...
						<td><a
							...
							data-confirm="Are you sure you want to delete?">Delete</a></td>
					</tr>
				</c:forEach>
			...
			<button type="button" class="btn btn-lg btn-primary"
				data-toggle="modal" data-target="#modalIngredientDetailId">Add</button>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLongTitle">Ingredient
					Detail</h5>
			...
			<sf:form class="form-horizontal" modelAttribute="ingredientDetail"
				action="${contextRoot}/laboratory/product/${product.id}/ingredients/ingredient"
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="col-md-8 validate">
							<sf:select path="ingredientId" items="${ingredients}"
					...
					<div class="form-group">
						...
						<div class="col-md-8 validate">
							<sf:radiobutton path="mark" value="false" checked="checked" />
							Halal
							<sf:radiobutton path="mark" value="true" />
							Haram
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-8 validate">
							<sf:input type="textarea" path="markDescription"
								class="form-control" placeholder="Mark Description" />
						</div>
					</div>
